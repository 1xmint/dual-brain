/**
 * install-hooks.ts — Merge dual-brain PreToolUse hooks into .claude/settings.json.
 *
...
const DESIRED_HOOKS: DesiredHook[] = [
 ...
 */
export function installHooks(cwd: string): { installed: string[]; skipped: string[] } {
